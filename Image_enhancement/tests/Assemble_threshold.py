...
ROOT_DIR = Path(r"E:\projects\datasets\Power_box\old\threshold_results")
LEFT_DIR_NAME = "009"
RIGHT_DIR_NAME = "010"
OUTPUT_DIR_NAME = "Assemble_threshold"
NAME_KEYWORD = "threshold_binary"
IMAGE_EXTENSIONS = {
    ".bmp",
    ".gif",
    ".jpeg",
...
def create_next_output_dir(root_dir: Path) -> Path:
    """Create the next three-digit run directory and its empty source-pair folder."""
...
def assemble_matching_images(
    ...
    """Assemble same-name threshold images into a new numbered run directory."""
